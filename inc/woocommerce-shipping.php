...
class Persian_Woocommerce_Shipping {
    ...
    public function __construct() {
        ...
        self::$methods = [ 'WC_Courier_Method',
                           'WC_Custom_Method',
                           'WC_Forehand_Method',
                           'WC_Tipax_Method', ];
    ...
    private function init_hooks() {
        ...
        add_action( 'wp_ajax_sabira_load_cities', [ $this, 'sabira_load_cities_callback' ] );
        add_action( 'wp_ajax_nopriv_sabira_load_cities', [ $this, 'sabira_load_cities_callback' ] );
        add_action( 'wp_ajax_sabira_load_districts', [ $this, 'sabira_load_districts_callback' ] );
        add_action( 'wp_ajax_nopriv_sabira_load_districts', [ $this, 'sabira_load_districts_callback' ] );
        add_action( 'woocommerce_shipping_init', [ $this, 'sabira_load_shipping_init' ] );
        ...
        add_filter( 'woocommerce_form_field_billing_sabira_cities', [ $this, 'checkout_cities_field' ], 11, 4 );
        add_filter( 'woocommerce_form_field_shipping_sabira_cities', [ $this, 'checkout_cities_field' ], 11, 4 );
        add_filter( 'woocommerce_form_field_billing_sabira_district', [ $this, 'checkout_cities_field' ], 11, 4 );
        add_filter( 'woocommerce_form_field_shipping_sabira_district', [ $this, 'checkout_cities_field' ], 11, 4 );
        add_filter( 'woocommerce_cart_shipping_packages', [ $this, 'add_district_cart_shipping_packages' ], 10, 1 );
        add_filter( 'woocommerce_cart_shipping_method_full_label', [ $this, 'add_image_before_shipping_labels' ], 10, 2 );
        add_filter( 'woocommerce_localisation_address_formats', [ $this, 'localisation_address_formats' ], 20, 1 );
        add_filter( 'woocommerce_order_formatted_shipping_address', [ $this, 'order_formatted_shipping_address' ], 20, 2 );
        add_filter( 'woocommerce_order_formatted_billing_address', [ $this, 'order_formatted_billing_address' ], 00, 2 );
        add_filter( 'woocommerce_formatted_address_replacements', [ $this, 'sabira_formatted_address_replacements' ], 10, 2 );
        add_filter( 'woocommerce_my_account_my_address_formatted_address', [ $this, 'my_account_my_address_formatted_address' ], 10, 3 );
    ...
    public function state_city_taxonomy() {
        ...
        register_taxonomy( 'state_city', null, [ 'hierarchical'       => true,
                                                 'labels'             => $labels,
                                                 'query_var'          => false,
                                                 'rewrite'            => false,
                                                 'public'             => false,
        ...
        foreach ( PWS_get_states() as $key => $state ) {
            ...
            foreach ( PWS_get_state_city( $key ) as $city )
                wp_insert_term( $city, 'state_city', [ 'parent'      => $term['term_id'],
    ...
    public function sabira_load_cities_callback() {
        ...
        $states = get_terms( [ 'taxonomy' => 'state_city', 'hide_empty' => false, 'parent' => $state_id ] );
    ...
    public function sabira_load_districts_callback() {
        ...
        $cities = get_terms( [ 'taxonomy' => 'state_city', 'hide_empty' => false, 'child_of' => $city_id ] );
    ...
    public function iran_states( $states ) {
        ...
        $_states = get_terms( [ 'taxonomy' => 'state_city', 'hide_empty' => false, 'parent' => 0 ] );
    ...
    public function edit_checkout_cities_field( $fields ) {
        ...
        foreach ( $types as $type ) {
            ...
            $fields[ $type ][ $type . '_city' ] = [ 'type'        => $type . '_sabira_cities',
                                                    'label'       => 'شهر',
            ...
            $fields[ $type ][ $type . '_district' ] = [ 'type'        => $type . '_sabira_district',
                                                        'label'       => 'محله',
    ...
    public function checkout_cities_field( $field, $key, $args, $value ) {
        ...
        if ( $args['type'] == 'billing_sabira_cities' || $args['type'] == 'shipping_sabira_cities' ) {
            ...
            if ( $state_cc ) {
                $options = get_terms( [ 'taxonomy' => 'state_city', 'hide_empty' => false, 'parent' => $state_cc ] );
            }
            ...
            if ( $city_cc ) {
                $options = get_terms( [ 'taxonomy' => 'state_city', 'hide_empty' => false, 'child_of' => $city_cc ] );
            }
        }
