...
if ( class_exists( 'WC_Forehand_Method' ) ) return; // Stop if the class already exists
...
class WC_Forehand_Method extends WC_Shipping_Method {
    ...
    public function calculate_shipping( $package = array() ) {
        ...
        $rate_price['1000']['in'] 		= 65000;
        $rate_price['1000']['out'] 		= 80000;

        $rate_price['2000']['in'] 		= 86000;
        $rate_price['2000']['out'] 		= 105000;

        $rate_price['9999']		 		= 21000;
        ...
        elseif ( $weight_indicator == '9999' )
            $shipping_total = $rate_price['2000'][$checked_state] + ( $rate_price[$weight_indicator] * ceil ( ( $weight - 2000) / 1000 ) );
